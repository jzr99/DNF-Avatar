...
def get_apose_bone_transforms(Jtr,):
    rot12p = Rotation.from_euler('z', 0.2, degrees=False).as_matrix()
    rot12n = Rotation.from_euler('z', -0.2, degrees=False).as_matrix()
    rot48p = Rotation.from_euler('z', 0.8, degrees=False).as_matrix()
    rot48n = Rotation.from_euler('z', -0.8, degrees=False).as_matrix()
...
def get_psfemale3pose_bone_transforms(Jtr,):
    rot12p = Rotation.from_euler('z', 0.2, degrees=False).as_matrix()
    rot12n = Rotation.from_euler('z', -0.2, degrees=False).as_matrix()
    rot48p = Rotation.from_euler('z', 0.2, degrees=False).as_matrix()
    rot48n = Rotation.from_euler('z', -0.2, degrees=False).as_matrix()
...
def get_pspose_bone_transforms(Jtr,):
    rot12p = Rotation.from_euler('z', 0.2, degrees=False).as_matrix()
    rot12n = Rotation.from_euler('z', -0.2, degrees=False).as_matrix()
